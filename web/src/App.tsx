    ...
    <div className="fixed inset-0 bg-[#050505] text-white overflow-hidden selection:bg-[#00CCFF]/30 desktop-wallpaper">
      ...
      <header className="absolute top-4 left-4 right-4 flex items-center justify-between z-0 pointer-events-none opacity-50 px-4">
        ...
        <div className="flex gap-4 items-center">
          <a
            href="/app-debug.apk"
            download="HazeBridge-Agent.apk"
            className="flex items-center gap-1.5 px-3 py-1 bg-[#00CCFF]/10 hover:bg-[#00CCFF]/20 border border-[#00CCFF]/30 rounded text-[9px] font-mono uppercase tracking-wider text-[#00CCFF] transition-all hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(0,204,255,0.2)] pointer-events-auto"
          >
